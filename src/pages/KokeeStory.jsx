    ...
    <div className={style.Container}>
      <div className={style.MainContent}>
        ...
        <div className={style.ImageGallery}>
          ...
          >
            <img
              src="/img/kokee-story-img/kokee-story-1.jpg"
          ...
          >
            <img
              src="/img/kokee-story-img/kokee-story-2.jpg"
              className={style.GalleryImage}
              alt="Kokee Drink"
            />
            <div className={style.ImageOverlay}>
          ...
          >
            <img
              src="/img/kokee-story-img/kokee-story-3.jpg"
              className={style.GalleryImage}
              alt="Kokee Drink"
            />
            <div className={style.ImageOverlay}>
          ...
          >
            <img
              src="/img/kokee-story-img/kokee-story-4.jpg"
              className={style.GalleryImage}
              alt="Kokee Drink"
            />
            <div className={style.ImageOverlay}>
